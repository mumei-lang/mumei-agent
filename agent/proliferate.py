...
from agent.proliferate_gaps import (
    _prefer_mcp_gaps_enabled,
    analyze_gaps,
    generate_specs_from_gaps,
)
from agent.proliferate_report import (
    _attach_dry_run_proof_certificate,
    _build_pr_body_extra,
    _duration_distribution,
    _jsonify_result,
    _lean_fallback_metrics,
...
from agent.proliferate_healing import (
    attempt_heal,
    check_blast_radius,
)
