...
| `vstd-trait-iterable`            | `std/trait/iterable.mm`                  | medium     | 3     | verified |
| `vstd-iter`                      | `std/iter.mm`                            | medium     | 5+    | verified |
| `vstd-hash`                      | `std/hash.mm`                            | medium     | 2+    | verified |
| `vstd-fixed-point`               | `std/math/fixed_point.mm`                | medium     | 2+    | verified |
| `vstd-safe-list`                 | `std/container/safe_list.mm`             | medium     | 2+    | verified |
| `vstd-string-utils`              | `std/string_utils.mm`                    | medium     | 2+    | verified |
| `vstd-math-abs`                  | `std/math/abs.mm`                        | low        | 2     | verified |
| `vstd-math-clamp`                | `std/math/clamp.mm`                      | low        | 2+    | verified |
| `vstd-math-gcd`                  | `std/math/gcd.mm`                        | low        | 2+    | verified |
| `vstd-math-sqrt`                 | `std/math/sqrt.mm`                       | medium     | 1     | verified |
| `vstd-math-min-max`              | `std/math/min_max.mm`                    | low        | 2+    | verified |
| `vstd-math-log2`                 | `std/math/log2.mm`                       | medium     | 1     | verified |
| `vstd-math-pow`                  | `std/math/pow.mm`                        | medium     | 2+    | verified |
| `vstd-math-pow-nat`              | `std/math/pow_nat.mm`                    | medium     | 2+    | verified |
| `vstd-math-safe-div`             | `std/math/safe_div.mm`                   | low        | 2     | verified |
| `vstd-math-safe-mul`             | `std/math/safe_mul.mm`                   | low        | 2+    | verified |
...
| `vstd-container-binary-heap`     | `std/container/binary_heap.mm`           | high       | 2+    | verified |
| `vstd-container-deque`           | `std/container/deque.mm`                 | medium     | 2+    | verified |
| `vstd-container-priority-queue`  | `std/container/priority_queue.mm`        | high       | 3     | verified |
| `vstd-container-ring-buffer`     | `std/container/ring_buffer.mm`           | medium     | 2+    | verified |
| `vstd-container-stack`           | `std/container/stack.mm`                 | medium     | 4+    | verified |
| `vstd-container-set`             | `std/container/set.mm`                   | high       | 3     | verified |
| `vstd-container-sorted-list`     | `std/container/sorted_list.mm`           | medium     | 3     | verified |
| `vstd-settlement`                | `std/settlement.mm`                      | hard       | 7     | verified |
| `vstd-regtech`                   | `std/compliance.mm`                      | medium     | 7     | verified |
