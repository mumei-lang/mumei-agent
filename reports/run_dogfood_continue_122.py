...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_122"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_122_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 122: {verified}/{len(summary)} verified")
