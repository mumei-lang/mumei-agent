...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_123"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_123_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 123: {verified}/{len(summary)} verified")
