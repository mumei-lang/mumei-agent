...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_124"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_124_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 124: {verified}/{len(summary)} verified")
