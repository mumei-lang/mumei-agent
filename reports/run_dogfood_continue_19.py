#!/usr/bin/env python3
"""Run deterministic (no-LLM) mumei-agent audit on the nineteenth batch of OSS files."""
...
OUT_DIR = Path(__file__).parent / "dogfood_continue_19"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_19_sample.json"
TIMEOUT = 240
