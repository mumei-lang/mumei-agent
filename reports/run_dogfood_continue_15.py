#!/usr/bin/env python3
"""Run deterministic (no-LLM) mumei-agent audit on the fifteenth batch of OSS files."""
...
OUT_DIR = Path(__file__).parent / "dogfood_continue_15"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_15_sample.json"
TIMEOUT = 240
