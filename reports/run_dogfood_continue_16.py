#!/usr/bin/env python3
"""Run deterministic (no-LLM) mumei-agent audit on the sixteenth batch of OSS files."""
...
OUT_DIR = Path(__file__).parent / "dogfood_continue_16"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_16_sample.json"
TIMEOUT = 240
