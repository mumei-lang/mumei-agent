#!/usr/bin/env python3
"""Run deterministic (no-LLM) mumei-agent audit on the eighteenth batch of OSS files."""
...
OUT_DIR = Path(__file__).parent / "dogfood_continue_18"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_18_sample.json"
TIMEOUT = 240
