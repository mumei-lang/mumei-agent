...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_127"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_127_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 127: {verified}/{len(summary)} verified")
