...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_130"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_130_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 130: {verified}/{len(summary)} verified")
