...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_129"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_129_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 129: {verified}/{len(summary)} verified")
