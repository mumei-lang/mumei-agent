...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_126"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_126_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 126: {verified}/{len(summary)} verified")
