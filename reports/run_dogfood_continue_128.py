...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_128"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_128_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 128: {verified}/{len(summary)} verified")
