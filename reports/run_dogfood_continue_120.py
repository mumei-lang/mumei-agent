...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_120"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_120_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 113: {verified}/{len(summary)} verified")
