...
REPORT_DIR = Path(__file__).parent / "dogfood_continue_125"
SAMPLE_FILE = Path(__file__).parent / "dogfood_continue_125_sample.json"
...
def main() -> None:
    ...
    print(f"\nBatch 125: {verified}/{len(summary)} verified")
