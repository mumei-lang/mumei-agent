...
| `get_agent_status(ctx)` | Inspect LLM settings, mumei binary configuration, feature flags, connected MCP client capabilities (sampling), and available subcommands. |
